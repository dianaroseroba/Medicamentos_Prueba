...
import 'package:application_medicines/utils/pdf_exporter.dart';
          ...
          IconButton(
            ...
            onPressed: () {
              ...
              if (medications.isEmpty) {
                Get.snackbar('Sin datos', 'No hay medicamentos para exportar.');
              } else {
                PdfExporter.exportMedicationsToPdf(medications);
              }
            },
